...
class Metis_Integrity_Manager {
    ...
    public static function verify_baseline( bool $verify_recovery = true ): array {
        self::ensure_runtime();
        ...
        $recovery_mismatches = $verify_recovery ? self::verify_recovery_snapshots( $expected_files ) : [];
        ...
        return [
            ...
            'recovery_checked' => $verify_recovery,
    ...
    private static function config(): array {
        ...
        $path = METIS_CONFIG_PATH . 'integrity.php';
        if ( ! file_exists( $path ) ) {
            $config = [];
            return $config;
        }
