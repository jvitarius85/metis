...
if ( ! function_exists( 'metis_bootstrap_root_path' ) ) {
    function metis_bootstrap_root_path(): string {
        $dir = __DIR__;
        for ( $i = 0; $i < 8; $i++ ) {
            $candidate = rtrim( $dir, '/\\' ) . '/';
...
$metis_composer_autoload = metis_bootstrap_root_path() . 'system/vendor/autoload.php';
...
foreach ( [
    'METIS_ROOT'            => $metis_bootstrap_root,
    'METIS_PATH'            => $metis_bootstrap_root,
    'METIS_SYSTEM_PATH'     => $metis_bootstrap_system,
    ...
    'METIS_TRANSITION_MODULES_PATH' => $metis_bootstrap_system . 'src/Metis/Core/TransitionModules/',
    ...
    'METIS_TESTS_PATH'      => $metis_bootstrap_system . 'tests/',
    'METIS_CLOUDFLARE_PATH' => $metis_bootstrap_system . 'cloudflare/',
    'METIS_VENDOR_PATH'     => $metis_bootstrap_system . 'vendor/',
] as $metis_constant => $metis_value ) {
    if ( ! defined( $metis_constant ) ) {
        define( $metis_constant, $metis_value );
    }
}
