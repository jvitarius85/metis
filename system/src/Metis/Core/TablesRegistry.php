...
final class Metis_Tables {
    ...
    private static array $tables = [
        ...
        "website_analytics_event_origins" => "metis_website_analytics_event_origins",
        "testimonies" => "metis_testimonies",
        "testimony_categories" => "metis_testimony_categories",
        "testimony_category_map" => "metis_testimony_category_map",
