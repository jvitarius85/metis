...
$metis_people_portal_dashboard_data = defined( 'METIS_CORE_SERVICES_PATH' )
...
if ( is_file( $metis_people_portal_dashboard_data ) ) {
    require_once $metis_people_portal_dashboard_data;
}
