...
<p class="metis-subtitle">Centralized credentials and endpoint references for integrations.</p>
<?php metis_settings_render_messages( $saved, $errors ); ?>
<?php metis_settings_render_section_nav( 'developers_api' ); ?>
<form method="post" enctype="multipart/form-data" class="metis-settings-form" data-metis-settings-form="1" data-settings-section="developers_api">
    <?php metis_runtime_nonce_field( 'metis_save_settings_developers_api', 'metis_settings_nonce' ); ?>

    <div class="metis-settings-card">
        <div class="metis-settings-header"><h2>Credentials</h2></div>
        <div class="metis-settings-body">
            <div class="metis-field">
                <label for="stripe_secret_credential_id">Stripe Key Credential</label>
                <select id="stripe_secret_credential_id" name="stripe_secret_credential_id" class="metis-input metis-input-wide">
                ...
                <input type="password" id="stripe_secret" name="stripe_secret" class="metis-input metis-input-wide" autocomplete="new-password" placeholder="<?php echo $stripe_connected ? metis_escape_attr( metis_mask_key( $stripe_secret ) ) : 'sk_live_••••••••••'; ?>" style="margin-top:8px;">
                <p class="metis-help">Paste to create/update the selected credential.</p>
            </div>
            <div class="metis-field">
                <label for="stripe_publishable_key">Stripe Publishable Key</label>
                <input type="password" id="stripe_publishable_key" name="stripe_publishable_key" class="metis-input metis-input-wide" autocomplete="new-password" placeholder="pk_live_...">
                <p class="metis-help">Required for inline Stripe Payment Element rendering on public forms.</p>
            </div>
            <div class="metis-field">
                <label for="stripe_webhook_secret_credential_id">Webhook Secret Credential</label>
                <select id="stripe_webhook_secret_credential_id" name="stripe_webhook_secret_credential_id" class="metis-input metis-input-wide">
                    <option value="">Select credential</option>
                ...
                <input type="password" id="stripe_webhook_secret" name="stripe_webhook_secret" class="metis-input metis-input-wide" autocomplete="new-password" placeholder="<?php echo $webhook_configured ? metis_escape_attr( metis_mask_key( $webhook_secret ) ) : 'whsec_••••••••••'; ?>" style="margin-top:8px;">
            </div>
            <div class="metis-field">
                <label for="workspace_service_account_json_credential_id">Google Service Account Credential</label>
                <select id="workspace_service_account_json_credential_id" name="workspace_service_account_json_credential_id" class="metis-input metis-input-wide">
                    <option value="">Select credential</option>
                ...
                <input type="file" id="workspace_service_account_json_file" name="workspace_service_account_json_file" class="metis-input metis-input-wide" accept="application/json,.json" style="margin-top:8px;">
            </div>
            <div class="metis-field">
                ...
                <input type="password" id="workspace_google_sso_client_secret" name="workspace_google_sso_client_secret" class="metis-input metis-input-wide" autocomplete="new-password" placeholder="<?php echo is_string( $workspace_google_sso_client_secret ) && trim( $workspace_google_sso_client_secret ) !== '' ? metis_escape_attr( metis_mask_key( (string) $workspace_google_sso_client_secret ) ) : 'GOCSPX-...'; ?>" style="margin-top:8px;">
                <p class="metis-help">Paste to create/update the selected credential.</p>
            </div>
            <div class="metis-field">
                <label for="workspace_impersonation_admin">Workspace Impersonation Admin (Breakglass)</label>
                <input type="email" id="workspace_impersonation_admin" name="workspace_impersonation_admin" class="metis-input metis-input-wide" value="<?php echo metis_escape_attr( (string) $workspace_impersonation_admin ); ?>" autocomplete="off" placeholder="admin@yourdomain.org">
            </div>
            <div class="metis-field">
                <label>Webhook Endpoint URL</label>
                <div class="metis-shortcode-wrap">
                    <code class="metis-shortcode" id="metis-webhook-url"><?php echo metis_escape_html( (string) $stripe_webhook_endpoint ); ?></code>
                    <button type="button" class="metis-btn metis-btn-xs metis-btn-ghost" data-copy-target="metis-webhook-url">Copy</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="metis-settings-card">
        ...
        <div class="metis-settings-body">
            <div class="metis-field">
                ...
                <input type="text" id="communications_inbound_google_project_id" name="communications_inbound_google_project_id" class="metis-input metis-input-wide" value="<?php echo metis_escape_attr( (string) $communications_inbound_google_project_id ); ?>" autocomplete="off" placeholder="your-google-project-id">
            </div>
            <div class="metis-field">
                <label for="communications_inbound_pubsub_topic">Pub/Sub Topic</label>
                <input type="text" id="communications_inbound_pubsub_topic" name="communications_inbound_pubsub_topic" class="metis-input metis-input-wide" value="<?php echo metis_escape_attr( (string) $communications_inbound_pubsub_topic ); ?>" autocomplete="off" placeholder="gmail-inbound">
                <p class="metis-help">Use a short topic name or a full <code>projects/.../topics/...</code> path.</p>
            </div>
            <div class="metis-field">
            ...
            <div class="metis-field">
                ...
                <input type="email" id="communications_inbound_pubsub_service_account_email" name="communications_inbound_pubsub_service_account_email" class="metis-input metis-input-wide" value="<?php echo metis_escape_attr( (string) $communications_inbound_pubsub_service_account_email ); ?>" autocomplete="off" placeholder="pubsub-push@your-project.iam.gserviceaccount.com">
            </div>
            <div class="metis-field">
                <label>Mailboxes To Watch</label>
                <p class="metis-help">Add each inbox you want Metis to monitor. Most teams only need the mailbox address and a friendly name.</p>
                <div class="metis-settings-repeatable">
                    <div class="metis-settings-repeatable-list" data-repeatable-list="inbound-mailbox">
                        <?php foreach ( $communications_inbound_mailboxes as $index => $row ) : ?>
                            <div class="metis-settings-row metis-settings-mailbox-row" data-repeatable-row>
                                ...
                                <div class="metis-field">
                                    ...
                                    <input type="email" class="metis-input" name="communications_inbound_mailboxes[<?php echo (int) $index; ?>][mailbox_email]" value="<?php echo metis_escape_attr( (string) ( $row['mailbox_email'] ?? '' ) ); ?>" placeholder="newsletter@example.org">
                                </div>
                                <div class="metis-field">
                                    <label>Mailbox Name</label>
                                    <input type="text" class="metis-input" name="communications_inbound_mailboxes[<?php echo (int) $index; ?>][display_name]" value="<?php echo metis_escape_attr( (string) ( $row['display_name'] ?? '' ) ); ?>" placeholder="Newsletter">
                                </div>
                                <div class="metis-field">
                                ...
                                <div class="metis-field">
                                    ...
                                    <input type="text" class="metis-input" name="communications_inbound_mailboxes[<?php echo (int) $index; ?>][label_ids]" value="<?php echo metis_escape_attr( implode( ', ', array_map( 'strval', (array) ( $row['label_ids'] ?? [] ) ) ) ); ?>" placeholder="INBOX">
                                    <p class="metis-help">Optional. Separate multiple labels with commas.</p>
                                </div>
                                <div class="metis-field">
                                    <label>Label Rule</label>
                                    <select class="metis-input" name="communications_inbound_mailboxes[<?php echo (int) $index; ?>][label_filter_behavior]">
                                ...
                                <button type="button" class="metis-btn metis-btn-xs metis-btn-danger" data-repeatable-remove>Remove</button>
                            </div>
                        <?php endforeach; ?>
                    </div>
                    <button type="button" class="metis-btn metis-btn-secondary metis-btn-xs" data-repeatable-add="inbound-mailbox">Add Mailbox</button>
                </div>
            </div>
            <div class="metis-field">
                <label for="communications_inbound_log_verbosity">Logging Verbosity</label>
                <select id="communications_inbound_log_verbosity" name="communications_inbound_log_verbosity" class="metis-input metis-input-wide">
            ...
            <div class="metis-field">
                ...
                <input type="number" min="1" max="90" id="communications_inbound_full_sync_days" name="communications_inbound_full_sync_days" class="metis-input metis-input-wide" value="<?php echo metis_escape_attr( (string) $communications_inbound_full_sync_days ); ?>">
            </div>
            <div class="metis-field">
            ...
            <div class="metis-field">
                ...
                <div class="metis-shortcode-wrap">
                    <code class="metis-shortcode" id="metis-gmail-pubsub-webhook"><?php echo metis_escape_html( (string) $gmail_pubsub_webhook_endpoint ); ?></code>
                    <button type="button" class="metis-btn metis-btn-xs metis-btn-ghost" data-copy-target="metis-gmail-pubsub-webhook">Copy</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="metis-settings-card">
        <div class="metis-settings-header"><h2>Endpoints</h2></div>
        <div class="metis-settings-body">
            <div class="metis-field"><label>AJAX</label><div class="metis-shortcode-wrap"><code class="metis-shortcode"><?php echo metis_escape_html( (string) $ajax_endpoint_url ); ?></code></div></div>
            <div class="metis-field"><label>Auth</label><div class="metis-shortcode-wrap"><code class="metis-shortcode"><?php echo metis_escape_html( (string) $api_auth_resolve_endpoint ); ?></code></div></div>
            <div class="metis-field"><label>Cron</label><div class="metis-shortcode-wrap"><code class="metis-shortcode"><?php echo metis_escape_html( (string) $system_cron_endpoint ); ?></code></div></div>
            <div class="metis-field"><label>Batch</label><div class="metis-shortcode-wrap"><code class="metis-shortcode"><?php echo metis_escape_html( (string) $batch_api_endpoint ); ?></code></div></div>
            <div class="metis-field"><label>Base URLs</label><div class="metis-shortcode-wrap"><code class="metis-shortcode"><?php echo metis_escape_html( (string) ( function_exists( 'metis_home_url' ) ? metis_home_url( '/' ) : '' ) ); ?></code></div></div>
        </div>
    </div>

    <div class="metis-settings-actions">
        <button type="submit" class="metis-btn">Save API & Endpoints</button>
    </div>
</form>
<script>
(function () {
    ...
    function createMailboxRow(index) {
        ...
        wrap.className = 'metis-settings-row metis-settings-mailbox-row';
        wrap.setAttribute('data-repeatable-row', '');
        wrap.innerHTML = `
            <input type="hidden" name="communications_inbound_mailboxes[${index}][mailbox_key]" value="">
            <div class="metis-field">
                <label>Mailbox Email</label>
                <input type="email" class="metis-input" name="communications_inbound_mailboxes[${index}][mailbox_email]" placeholder="newsletter@example.org">
            </div>
            <div class="metis-field">
                <label>Mailbox Name</label>
                <input type="text" class="metis-input" name="communications_inbound_mailboxes[${index}][display_name]" placeholder="Newsletter">
            </div>
            <div class="metis-field">
                <label>Google User</label>
            ...
            <div class="metis-field">
                <label>Inbox Labels</label>
                <input type="text" class="metis-input" name="communications_inbound_mailboxes[${index}][label_ids]" placeholder="INBOX">
                <p class="metis-help">Optional. Separate multiple labels with commas.</p>
            </div>
            <div class="metis-field">
                <label>Label Rule</label>
                <select class="metis-input" name="communications_inbound_mailboxes[${index}][label_filter_behavior]">
