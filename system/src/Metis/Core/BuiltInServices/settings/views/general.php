...
?>
<h1 class="metis-page-title"><?php echo metis_escape_html( metis_current_module_label( 'Settings' ) ); ?></h1>
<p class="metis-subtitle">Manage portal identity.</p>
<?php metis_settings_render_messages( $saved, $errors ); ?>
<?php metis_settings_render_section_nav( 'general' ); ?>
<form method="post" class="metis-settings-form" data-metis-settings-form="1" data-settings-section="general">
    ...
    <div class="metis-settings-card">
        ...
        <div class="metis-settings-body">
            ...
            <div class="metis-field">
                ...
                <input type="text" id="org_name" name="org_name" class="metis-input metis-input-wide" value="<?php echo metis_escape_attr( $org_name ); ?>" placeholder="Mobilize Waco">
            </div>
            <div class="metis-field">
                <label for="org_tagline">Organization Tagline</label>
                <input type="text" id="org_tagline" name="org_tagline" class="metis-input metis-input-wide" value="<?php echo metis_escape_attr( (string) $org_tagline ); ?>" placeholder="Access. Visibility. Leadership.">
            ...
            <div class="metis-field">
                ...
                <p class="metis-help">Only published pages are available. This setting controls route <code>/</code>.</p>
            </div>
            <div class="metis-field">
                <label for="timezone">Timezone</label>
                <select id="timezone" name="timezone" class="metis-input metis-input-wide">
                ...
                <p class="metis-help">Default timezone for logs, reports, and date/time rendering.</p>
            </div>
            <div class="metis-field">
                <label for="date_format_choice">Date Format</label>
                <select id="date_format_choice" name="date_format_choice" class="metis-input metis-input-wide">
                ...
                <div id="date_format_custom_wrap" style="<?php echo $date_format_choice === 'custom' ? '' : 'display:none;'; ?> margin-top:8px;">
                    <input type="text" id="date_format_custom" name="date_format_custom" class="metis-input metis-input-wide" value="<?php echo metis_escape_attr( (string) $date_format_custom ); ?>" placeholder="yyyy.mm.dd">
                    <p class="metis-help">Custom tokens: <code>yyyy</code>, <code>yy</code>, <code>mm</code>, <code>m</code>, <code>dd</code>, <code>d</code>.</p>
                </div>
                <p class="metis-help" id="date_format_preview">Preview: <?php echo metis_escape_html( $format_preview( (string) $date_format ) ); ?></p>
            </div>
            <div class="metis-field">
                <label for="time_format_choice">Time Format</label>
                <select id="time_format_choice" name="time_format_choice" class="metis-input metis-input-wide">
                ...
                <div id="time_format_custom_wrap" style="<?php echo $time_format_choice === 'custom' ? '' : 'display:none;'; ?> margin-top:8px;">
                    <input type="text" id="time_format_custom" name="time_format_custom" class="metis-input metis-input-wide" value="<?php echo metis_escape_attr( (string) $time_format_custom ); ?>" placeholder="h:m:s a/m">
                    <p class="metis-help">Custom tokens: <code>HH</code>, <code>H</code>, <code>hh</code>, <code>h</code>, <code>mm</code>/<code>m</code>, <code>ss</code>/<code>s</code>, <code>a/m</code> or <code>A/P</code>.</p>
                </div>
                <p class="metis-help" id="time_format_preview">Preview: <?php echo metis_escape_html( $format_preview( (string) $time_format ) ); ?></p>
            </div>
            <div class="metis-field">
                <label>Combined Preview</label>
                <div class="metis-help" id="datetime_format_preview"><?php echo metis_escape_html( $format_preview( (string) $date_format . ' ' . (string) $time_format ) ); ?></div>
            </div>
            <details class="metis-field">
                <summary><strong>Show Brand Assets</strong></summary>
                <div class="metis-field" data-settings-media-field="portal_logo">
                    <label>Logo</label>
                    <div class="metis-logo-upload">
                        ...
                        <?php else : ?>
                            ...
                            <p class="metis-help" data-settings-media-empty="portal_logo">No logo selected yet.</p>
                        <?php endif; ?>
                        ...
                        <button type="button" class="metis-btn metis-btn-ghost metis-btn-sm" data-settings-media-pick="portal_logo" data-settings-media-types="image">Choose from Media Library</button>
                        <button type="button" class="metis-btn metis-btn-ghost metis-btn-sm" data-settings-media-clear="portal_logo">Clear selection</button>
                        <p class="metis-help">Uses the centralized Media Library. Recommended max logo size: 2 MB.</p>
                        <?php if ( $portal_logo_src !== '' ) : ?>
                ...
                <div class="metis-field" data-settings-media-field="portal_favicon">
                    <label>Favicon</label>
                    <div class="metis-logo-upload">
                        ...
                        <?php else : ?>
                            ...
                            <p class="metis-help" data-settings-media-empty="portal_favicon">No favicon selected yet.</p>
                        <?php endif; ?>
                        ...
                        <button type="button" class="metis-btn metis-btn-ghost metis-btn-sm" data-settings-media-pick="portal_favicon" data-settings-media-types="image">Choose from Media Library</button>
                        <button type="button" class="metis-btn metis-btn-ghost metis-btn-sm" data-settings-media-clear="portal_favicon">Clear selection</button>
                        <p class="metis-help">Uses the centralized Media Library. Use a square image, ideally 32x32 or 48x48.</p>
                        <?php if ( $portal_favicon_src !== '' ) : ?>
                            <label class="metis-settings-flag">
    ...
    <div class="metis-settings-actions">
        <button type="submit" class="metis-btn">Save General Settings</button>
    </div>
</form>
<script>
(function() {
