...
$formsRenderer = $read( 'modules/Forms/FormRenderer.php' );
$websiteThemeView = $read( 'modules/website/views/theme.php' );
$themeService = $read( 'modules/Website/Services/ThemeService.php' );
...
$formsRepository = $read( 'modules/Forms/Concerns/SharedRepositoryLogic.php' );
$sanitizationRuntime = $read( 'src/Metis/Core/Runtime/SanitizationRuntime.php' );
$donationsCampaignService = $read( 'modules/Donations/CampaignService.php' );
$donationsReadService = $read( 'modules/Donations/ReadService.php' );
$peopleReadService = $read( 'src/Metis/Core/BuiltInServices/people/ReadService.php' );
$newsletterReadService = $read( 'modules/Newsletter/ReadService.php' );
$profileDashboardView = $read( 'modules/profile/views/dashboard.php' );
$peoplePersonView = $read( 'modules/people/views/person.php' );
...
$boardBylawsService = $read( 'modules/Board/BylawsService.php' );
$boardDecisionAttendanceService = $read( 'modules/Board/DecisionAttendanceService.php' );
$boardWorkflowTemplateService = $read( 'modules/Board/WorkflowTemplateService.php' );
...
$donationsTransactionMutationService = $read( 'modules/Donations/TransactionMutationService.php' );
$donationsBootstrap = $read( 'modules/donations/bootstrap.php' );
$donationsModule = $read( 'modules/Donations/DonationsModule.php' );
...
$contactMutationService = $read( 'modules/Contacts/ContactMutationService.php' );
$contactsAjax = $read( 'modules/contacts/ajax/contacts.ajax.php' );
$recurringDonationsService = $read( 'modules/Donations/RecurringDonationsService.php' );
$websiteAjax = $read( 'modules/website/ajax/website.ajax.php' );
$websiteRenderer = $read( 'modules/Website/Services/WebsiteRenderer.php' );
$menuService = $read( 'modules/Website/Services/MenuService.php' );
$publicNavigationJs = $read( 'modules/website/assets/public-navigation.js' );
$revisionTimelineService = $read( 'modules/Website/Services/RevisionTimelineService.php' );
$testimoniesAjax = $read( 'modules/testimonies/assets/testimonies.ajax.php' );
$websiteBlockRegistry = $read( 'modules/Website/BlockRegistry.php' );
...
$assert( str_contains( $profileDashboardView, 'metis_render_error_state' ) && str_contains( $peoplePersonView, 'metis_render_error_state' ), 'Profile and People detail entry points must use the shared error-state renderer for unavailable records and denied access.' );
