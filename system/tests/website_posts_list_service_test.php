...
namespace {
    ...
    require_once $resolve_relative( 'modules/Website/Services/PostsListService.php' );
    ...
    $blockRendererSource = (string) file_get_contents( $resolve_relative( 'modules/Website/Services/BlockRenderer.php' ) );
