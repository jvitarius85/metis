...
$modernized_shared_paths = [
    ...
    $resolve_relative( 'modules/settings/views/customization.php' ),
    $resolve_relative( 'modules/settings/views/developers_api.php' ),
    $resolve_relative( 'modules/settings/views/general.php' ),
    $resolve_relative( 'modules/settings/views/logging.php' ),
    $resolve_relative( 'modules/settings/views/about.php' ),
    $resolve_relative( 'modules/settings/views/accessibility.php' ),
    $resolve_relative( 'modules/settings/views/backup.php' ),
    $resolve_relative( 'modules/settings/views/cache.php' ),
    $resolve_relative( 'modules/settings/views/calendar.php' ),
    $resolve_relative( 'modules/settings/views/checker.php' ),
    $resolve_relative( 'modules/settings/views/drive.php' ),
    $resolve_relative( 'modules/settings/views/help.php' ),
    $resolve_relative( 'modules/settings/views/jobs_tasks.php' ),
    $resolve_relative( 'modules/settings/views/menu.php' ),
    $resolve_relative( 'modules/settings/views/newsletter.php' ),
    $resolve_relative( 'modules/settings/views/operations.php' ),
    $resolve_relative( 'modules/settings/views/payments.php' ),
    $resolve_relative( 'modules/settings/views/profile.php' ),
    $resolve_relative( 'modules/settings/views/runtime.php' ),
    $resolve_relative( 'modules/settings/views/scheduler.php' ),
    $resolve_relative( 'modules/settings/views/user_experience.php' ),
    $resolve_relative( 'modules/settings/views/workspace.php' ),
    $resolve_relative( 'modules/settings/views/_settings_bootstrap.php' ),
    $resolve_relative( 'modules/settings/assets/settings.ajax.php' ),
