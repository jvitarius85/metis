...
$modernized_shared_paths = [
    ...
    $root . '/modules/Board/Support.php',
    $root . '/modules/Board/WorkspaceService.php',
    $root . '/modules/Calendar/CalendarModule.php',
    $root . '/modules/Calendar/Settings.php',
    $root . '/modules/Calendar/SyncStore.php',
    $root . '/src/Metis/Core/TransitionModules/communications_inbound/InboundMessageNormalizer.php',
    $root . '/src/Metis/Core/TransitionModules/communications_inbound/MailboxRepository.php',
    $root . '/src/Metis/Core/TransitionModules/communications_inbound/Settings.php',
    $root . '/src/Metis/Core/TransitionModules/communications_inbound/WorkspaceGoogleService.php',
    $root . '/modules/Donations/DonationsModule.php',
    $root . '/modules/Finance/SchemaManager.php',
    $root . '/modules/Finance/FinanceV2Service.php',
    $root . '/modules/Forms/Concerns/SharedRepositoryLogic.php',
    $root . '/modules/Forms/FormRenderer.php',
    $root . '/modules/Forms/FormSubmissionRepository.php',
    $root . '/modules/Forms/FormsModule.php',
    $root . '/modules/GrandyStash/GrandyStashRepository.php',
    $root . '/modules/GrandyStash/GrandyStashModule.php',
    $root . '/modules/GrandyStash/GrandyStashSupport.php',
    $root . '/modules/Newsletter/DeliveryService.php',
    $root . '/modules/Newsletter/QueueService.php',
    $root . '/modules/Newsletter/Support.php',
    $root . '/src/Metis/Core/BuiltInServices/people/AccessManager.php',
    $root . '/src/Metis/Core/BuiltInServices/people/ActivityService.php',
    $root . '/src/Metis/Core/BuiltInServices/people/SchemaManager.php',
    $root . '/src/Metis/Core/BuiltInServices/people/Support.php',
    $root . '/modules/Website/Services/BlockRenderer.php',
    $root . '/modules/Website/Services/BannerService.php',
    $root . '/modules/Website/Services/LayoutProfileService.php',
    $root . '/modules/Website/Services/PageService.php',
    $root . '/modules/Website/Services/PopupService.php',
    $root . '/modules/Website/Services/PostCategoryService.php',
    $root . '/modules/Website/Services/PostService.php',
    $root . '/modules/Website/Services/ReusableBlockService.php',
    $root . '/modules/Website/Services/RevisionTimelineService.php',
    $root . '/modules/Website/Services/StructuredWebsiteBuilderService.php',
    $root . '/modules/Website/Services/TemplateService.php',
    $root . '/modules/Website/Services/ThemeService.php',
    $root . '/modules/Website/Services/WebPartService.php',
    $root . '/modules/Website/Services/WebsiteRenderer.php',
    ...
    $resolve_relative( 'modules/portal/views/dashboard.php' ),
    $resolve_relative( 'modules/portal/assets/portal.ajax.php' ),
    $resolve_relative( 'modules/portal/views/email_usage.php' ),
    $resolve_relative( 'modules/portal/views/settings.php' ),
    $resolve_relative( 'modules/people/ajax/people.ajax.php' ),
    $resolve_relative( 'modules/people/ajax/groups.ajax.php' ),
    $resolve_relative( 'modules/people/ajax/jobs.ajax.php' ),
    $resolve_relative( 'modules/people/ajax/mfa.ajax.php' ),
    $resolve_relative( 'modules/people/ajax/permissions.ajax.php' ),
    $resolve_relative( 'modules/people/ajax/requests.ajax.php' ),
    $resolve_relative( 'modules/people/ajax/roles.ajax.php' ),
    $resolve_relative( 'modules/people/ajax/templates.ajax.php' ),
    $resolve_relative( 'modules/people/ajax/workspace.ajax.php' ),
    $resolve_relative( 'modules/people/views/access_requests.php' ),
    $resolve_relative( 'modules/people/views/activity.php' ),
    $resolve_relative( 'modules/people/views/bulk_actions.php' ),
    $resolve_relative( 'modules/people/views/dashboard.php' ),
    $resolve_relative( 'modules/people/views/people_list.php' ),
    $resolve_relative( 'modules/people/views/person.php' ),
    $resolve_relative( 'modules/people/views/positions.php' ),
    $resolve_relative( 'modules/people/views/role.php' ),
    $resolve_relative( 'modules/people/views/roles_list.php' ),
    $resolve_relative( 'modules/people/views/templates.php' ),
    $resolve_relative( 'modules/people/views/permissions.php' ),
    $resolve_relative( 'modules/people/views/workspace.php' ),
    $resolve_relative( 'modules/profile/assets/profile.ajax.php' ),
    $resolve_relative( 'modules/profile/views/dashboard.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/customization.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/developers_api.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/general.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/logging.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/about.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/accessibility.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/backup.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/cache.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/calendar.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/checker.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/drive.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/help.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/jobs_tasks.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/menu.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/newsletter.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/operations.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/payments.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/profile.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/runtime.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/scheduler.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/user_experience.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/workspace.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/views/_settings_bootstrap.php' ),
    $resolve_relative( 'src/Metis/Core/BuiltInServices/settings/assets/settings.ajax.php' ),
