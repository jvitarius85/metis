...
- `POST /system/enclave/help/search.php`
- `POST /system/enclave/help/article/save.php`
- `POST /system/enclave/help/article/publish.php`
- `POST /system/enclave/help/article/unpublish.php`
- `POST /system/enclave/help/index/rebuild.php`
